...
analysis_engine            codex for the production workflow
```
...
```powershell
radar doctor
radar run --config configs/diesel_90d.yaml --start-date 2025-09-01 --end-date 2026-08-31 --depth standard --analysis-engine codex --communities Cummins,Duramax,powerstroke,FordDiesels
